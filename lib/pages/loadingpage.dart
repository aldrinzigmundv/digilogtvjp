...
class _LoadingPageState extends State<LoadingPage> {
  ...
  String _bottomMessage = 'aldrinzigmund.com によって提供されています';
  ...
  _showUpdateDialogBox(String updatemessage) async {
    await showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: const Text('Digilog TVが更新されました'),
  ...
  Future<void> fetchAndStoreChannelList() async {
    const String remoteJsonUrl =
        'https://raw.githubusercontent.com/aldrinzigmundv/digilogtvjp/master/assets/data/channels.json';
    ...
    try {
      ...
      if (mounted) {
        setState(() {
        _bottomMessage = 'チャンネルリストをオンラインで取得できませんでした';
      });
      }
